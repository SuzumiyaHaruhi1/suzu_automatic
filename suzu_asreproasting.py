...
class Asreproasting:
    ...
    def argument_parser(self):
        ...
        if self.users_file:
            ...
            self.option = 1
            print(
                f"IP Address: {args.dc_ip}, Domain: {args.domain}, Users File: {args.users_file}, Wordlist: {args.wordlist}")
        else:
            ...
            self.option = 2
            print(
                f"IP Address: {args.dc_ip}, Domain: {args.domain}, Username: {args.username}, "
                f"Credentials: {args.credentials}, Wordlist: {args.wordlist}")
